CoderA = 'Plusardx' -- PUT CODER'S USER HERE
ComposerB = 'SimplyCrispy, Saster, MarStarBro and KGBepis' -- PUT COMPOSER'S USER HERE
ArtistC = 'Wednesdays Infidelity' -- PUT ARTIST'S USER HERE
CharterD = 'LOQUEND1496' -- PUT CHARTER'S USER HERE
